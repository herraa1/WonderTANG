...
create_clock -name clk3 -period 139.665 -waveform {0 69.832} [get_ports {clock}] -add
//create_clock -name clk3h -period 279.33 -waveform {0 139.665} [get_regs {ff_hclock_s0}] -add